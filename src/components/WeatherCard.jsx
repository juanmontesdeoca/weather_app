    ...
    <section className='weather__body'>
      ...
      <h3 className='weather__description'>{weather?.weather[0].description}   </h3>
        <ul className='weather__list'>
            <li className='weather__item'><span>Wind speed</span><span className='weather__value'>{weather?.wind.speed}m/s</span></li>
            <li className='weather__item'><span>Clouds</span><span className='weather__value'>{weather?.clouds.all}%</span></li>
            <li className='weather__item'><span>Pressure</span><span className='weather__value'>{weather?.main.pressure}hPa</span></li>
        </ul>
      </article>
    </section>
